...
redA = (usuariosA, relacionesA, publicacionesA) -- RedA, básica

usuariosB = [usuario1, usuario2, usuario3, usuario5]
relacionesB = [relacion1_2, relacion2_3]
publicacionesB = [publicacion1_3, publicacion1_4, publicacion1_5, publicacion3_1, publicacion3_2, publicacion3_3]
redB = (usuariosB, relacionesB, publicacionesB) -- RedB, básica con nombre de usuario repetido
...
redC = (usuariosC, relacionesC, publicacionesC) -- RedC, básica con pocas publicaciones
...
relacionesEnCadena = [relacion1_2, relacion2_3, relacion3_4, relacion4_5, relacion3_5, relacion2_5,
    relacion1_3,relacion6_8, relacion9_10, relacion7_8, relacion6_7, relacion11_12, relacion10_11]
...
testSuiteEj1 = test [
    ...
    "Caso 3: RedSocial con más de un usuario" ~: esPermutacion (nombresDeUsuarios red3) ["Juan", "Natalia", "Pedro", "Mariela"],
    "Caso 4: RedSocial con usuarios del mismo nombre" ~: esPermutacion (nombresDeUsuarios red4) ["Juan", "Natalia", "Pedro"],
    "Caso 4: RedSocial con usuarios, varios casos del mismo nombre" ~: esPermutacion (nombresDeUsuarios red5) ["Juan", "Natalia", "Pedro","Mariela","Alex","Lucía","Roberto","María","Don José"]
    ]
...
testSuiteEj2 = test [
    ...
    "Caso 4: RedSocial con más de un usuario y relaciones, usuario con más de un amigo" ~: esPermutacion (amigosDe redA usuario2) [(1, "Juan"), (3, "Pedro"), (4, "Mariela")]
    ]
...
testSuiteEj5 = test [
    ...
    "Caso 2: RedSocial con un único usuario, sin relaciones" ~: (estaRobertoCarlos red2) ~?= False,
...
testSuiteEj6 = test [
    ...
    "Caso 1: RedSocial con un único usuario, sin publicaciones" ~: (publicacionesDe red2 usuario1) ~?= [],
    "Caso 2: RedSocial con un único usuario, con publicaciones" ~: esPermutacion (publicacionesDe ([usuario1],[],[publicacion1_6,publicacion1_7]) usuario1) [publicacion1_7,publicacion1_6],
    "Caso 3: RedSocial con más de un usuario, sin publicaciones" ~: (publicacionesDe red3 usuario1) ~?= [],
    "Caso 4: RedSocial con más de un usuario y publicaciones, usuario5 sin publicaciones" ~: (publicacionesDe redC usuario5) ~?= [],
    "Caso 5: RedSocial con más de un usuario y publicaciones, usuario1 con publicaciones" ~: esPermutacion (publicacionesDe redA usuario1) [publicacion1_1, publicacion1_2]
    ]
